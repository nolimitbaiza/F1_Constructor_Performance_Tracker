...
# Project root = parent of this file's directory (scripts/)
...
# Load months present in gold and format as 'YYYY-MM'
...
# Render a Top-10 PNG for every available month using your report module
for ym in months:
    subprocess.run(
